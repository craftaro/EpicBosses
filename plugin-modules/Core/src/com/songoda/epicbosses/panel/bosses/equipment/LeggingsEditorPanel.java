 ...
 * @since 19-Nov-18
 */
public class LeggingsEditorPanel extends ItemStackSubListPanelHandler {

    public LeggingsEditorPanel(BossPanelManager bossPanelManager, ConfigurationSection configurationSection, CustomBosses plugin) {
    ...
    public void getUpdateAction(EntityStatsElement entityStatsElement, String newName) {
        entityStatsElement.getEquipment().setLeggings(newName);
    }

    @Override
    public String getCurrent(EntityStatsElement entityStatsElement) {
        return entityStatsElement.getEquipment().getLeggings();
    }
}